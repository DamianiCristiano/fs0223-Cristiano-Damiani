...
for (posizione = 0; posizione < starWarsCharacters.length; posizione++) {
  switch (starWarsCharacters[posizione].eye_color) {
    case 'blue':
      eyeColor.blue.push(starWarsCharacters[posizione]);
      break
    case 'yellow':
      eyeColor.yellow.push(starWarsCharacters[posizione]);
      break
    case 'brown':
      eyeColor.brown.push(starWarsCharacters[posizione]);
      break
    case 'red':
      eyeColor.red.push(starWarsCharacters[posizione]);
      break
    case 'blue-gray':
      eyeColor.blue_gray.push(starWarsCharacters[posizione]);
      break
    default:
        console.log(starWarsCharacters[posizione])
    }
}
...
/* ESERCIZIO 6
  ...
  */
  ...
  while (index < starWarsCharacters.length) {
    pesoTotale += parseInt(starWarsCharacters[index].mass)
    index++
  }
